...
public class adminclase extends SQLiteOpenHelper {
    ...
    public adminclase(Context context){
        super(context,DB_NAME, null, DB_VERSION);
    }


    public adminclase(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
